...
//}
//
//DiameterMessage *DiameterS6a::processULR(DiameterMessage *ulr) {
//	DiameterMessage *ula = new DiameterMessage("Update-Location-Response");
...
//				processULA(msg);
//			break;
//		default:;	// TODO should send some "unknown command" result back
//	}
//	delete msg;
//	return resp;
}
