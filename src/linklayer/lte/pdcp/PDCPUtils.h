...
static const unsigned char R128[4 * NB] = {
...
private:
    ...
    unsigned cmac(unsigned char *k, unsigned char *m, unsigned mlen);
public:
    PDCPUtils();
    virtual ~PDCPUtils();

    unsigned calcMacI(unsigned count, unsigned char bearer, bool direction, PDCPDataPduCPlane *msg);
};
